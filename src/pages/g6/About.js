    ...
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div className="snap-center h-screen relative flex flex-row justify-center items-center">
        <div className="basis-1/3 text-center place-items-center">
          ...
          <div className="pb-8 pt-16 font-sans font-black text-xl tracking-widest">VIVARIUM</div>
      ...
      <div className="relative snap-center h-screen flex items-center">
        ...
        <Link to={"/g" + group + "/map"}>
          <button className="absolute bottom-24 left-1/2 transform -translate-x-1/2 inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-[#bb86c4] to-[#e13483] group-hover:from-[#bb86c4] group-hover:to-[#e13483] hover:text-white">
