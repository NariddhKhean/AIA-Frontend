  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div style={{backgroundImage: "url(/bg-vienna-white.png)"}} className="relative bg-cover bg-center snap-center h-screen flex items-center bg-black">
        ...
        <div className="p-8 bg-[#FFFFFF80] text-lg"><span className="font-bold">Game of Green</span> is an urban rewilding project for Vienna 2050. The purpose of this project is to create a Toolbox to visualize a future urban map using Machine Learning to green valid spaces. The result would democratizing the inhabitants participatory opinions, raise awareness, enhance viability, production, and sustainability.</div>
          </div>
    </div>
      </div>
