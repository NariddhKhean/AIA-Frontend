  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div className="relative snap-center h-screen flex items-center">
        ...
        <Link to={"/g" + group + "/map"}>
          <button className="absolute bottom-16 left-1/2 transform -translate-x-1/2 inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-[#e13483] to-[#fc9b47] group-hover:from-[#e13483] group-hover:to-[#fc9b47] hover:text-white">
