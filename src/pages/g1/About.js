  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div className="relative snap-center h-screen flex items-center">
        ...
        <Link to={"/g" + group + "/map"}>
          <button className="absolute bottom-24 left-1/2 transform -translate-x-1/2 inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-[#fc9b47] to-[#dac710] group-hover:from-[#fc9b47] group-hover:to-[#dac710] hover:text-white">
